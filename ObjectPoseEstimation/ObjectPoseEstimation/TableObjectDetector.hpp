...
TableObjectDetector<PointType> :: TableObjectDetector() : m_max_dist_to_plane(0.03) {
	
	// ---[ Create all PCL objects and set their parameters
	setObjectVoxelSize(ope::objectVoxelSize);
	setBackgroundVoxelSize();
	setDepthLimits(ope::minimumTgtDepth, ope::maximumTgtDepth);
